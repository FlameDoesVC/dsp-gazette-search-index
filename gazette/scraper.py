# https://github.com/kudanai/gazettegram/blob/master/api/scraper.py
...
async def get_max_page_number(client, type: GazetteType | None = None):
    """
...
async def fetch_index_links(client, type: GazetteType | None = None, page_number: int = 1):
    """
